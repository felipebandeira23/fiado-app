...
class ClienteForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            'nome': forms.TextInput(attrs={'autofocus': True, 'placeholder': 'Nome completo do cliente', 'minlength': 3}),
    ...
    def clean_nome(self):
        ...
        if len(nome) < 3:
            raise forms.ValidationError('Informe um nome com pelo menos 3 caracteres.')
        return nome
